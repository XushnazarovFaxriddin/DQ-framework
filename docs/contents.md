...
- Configuration
  - `docs/configuration/basics.md` — Core YAML structure for connections, tables, checks, and alerts.
  - `docs/configuration/advanced.md` — Mismatch sampling, table stats, adaptive thresholds, severity, and result persistence knobs.
...
- Checks (Validation Types)
  ...
  - `docs/checks/table_stats.md` — Capture per-period aggregates and persist them into the monitoring table.
  - `docs/checks/stats_compare.md` — Compare stored stats between source and target per bucket.
